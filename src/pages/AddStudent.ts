...
const addStudentForm = document.querySelector<HTMLFormElement>('form') as HTMLFormElement;
...
const studentIsActiveInput = document.getElementById('isActive') as HTMLInputElement;

function handleAddStudent(event: Event): void {
    event.preventDefault();

    const newStudent: Student = {
        id: studentIDInput.value ? parseInt(studentIDInput.value) : studentList.length + 1,
        ...
        active: studentIsActiveInput.checked
    };
